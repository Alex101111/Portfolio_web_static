...
function revealMyIntrests(){
 ...
 function changeImg() {
    ...
    swipe = 'translateX(' + IntrestsCount * -200 + 'px)'
    }else{
...
function rollIcon(){
    let skillIcons =document.querySelectorAll('.skillIcon')
    let skillText = document.querySelectorAll('.skillsSection h3')
    let skillPoints = document.querySelectorAll('.progressBar ul li')
    ...
    window.addEventListener('scroll',rollIcon);